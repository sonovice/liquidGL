        ...
        try {
          ...
          if (clonedCtx) {
            if (!this.options.allowTaint && ctx) {
              ...
              var gl = (_a = canvas.getContext("webgl2")) !== null && _a !== undefined ? _a : canvas.getContext("webgl");
              if (gl) {
...
function liquidGL(options = {}) {
  return window.liquidGL(options);
}
liquidGL.registerDynamic = function registerDynamic(elements) {
  return window.liquidGL.registerDynamic(elements);
};
liquidGL.syncWith = function syncWith(config = {}) {
  return window.liquidGL.syncWith(config);
};
var src_default = liquidGL;
export {
  liquidGL,
  src_default as default
};

//# debugId=842E60A53716890D64756E2164756E21
